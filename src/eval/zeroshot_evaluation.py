...
from src.training.main import convert_models_to_fp32
from src.clip.utils import image_transform
from src.eval.data import get_zeroshot_dataset, _preprocess_text
from src.eval.cvinw_zeroshot_templates import (
    openai_templates,
    flower_templates,
    food_templates,
    aircraft_templates,
