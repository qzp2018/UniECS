...
def parse_args():
    ...
    parser.add_argument("--alpha1", type=float, default=0.5, help="Margin for PPM loss")
    parser.add_argument("--alpha2", type=float, default=0.3, help="Margin for PDC loss") 
    parser.add_argument("--alpha3", type=float, default=0.03, help="Target similarity for PLC loss")
    parser.add_argument(
        "--ppm-weight", 
        type=float,
        default=1.0,
