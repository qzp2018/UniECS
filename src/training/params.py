...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0, 
        help="Weight for text-to-text contrastive loss"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.3,
        help="Weight for vision to text contrastive loss"
    )
    parser.add_argument(
        "--v2f_weight",
        type=float,
        default=0.3, 
        help="Weight for vision to fusion contrastive loss"
    )
    parser.add_argument(
        "--t2f_weight",
        type=float,
        default=0.3, 
        help="Weight for text to fusion contrastive loss"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0, 
        help="Weight for vision-to-vision contrastive loss"
    )
    parser.add_argument(
        "--reset-optimizer",
        action="store_true",
    ...
    parser.add_argument("--alpha1", type=float, default=0.3, help="Margin for PPM loss")
    parser.add_argument("--alpha2", type=float, default=0.2, help="Margin for PDC loss") 
    parser.add_argument("--alpha3", type=float, default=0.05, help="Target similarity for PLC loss")
    parser.add_argument(
        "--ppm-weight", 
        type=float,
        default=0.8,
        help="Weight for Product to Product Matching Loss"
    )
    parser.add_argument(
        "--pdc-weight",
        type=float, 
        default=0.5,
        help="Weight for Product Self-Distinctiveness Loss"
    )
    parser.add_argument(
        "--plc-weight",
        type=float,
        default=0.5, 
        help="Weight for Product Locality Consistency Loss"
    )
    parser.add_argument(
        "--vision-lr", 
        type=float, 
        default=None, 
        help="Learning rate for vision encoder. If None, use the same as --lr."
    )
    ...
    parser.add_argument(
        ...
        type=float, 
        default=0.03, 
        help="Temperature for vision-to-vision contrastive loss"
    )
    parser.add_argument(
        "--vision-model",
